...
export default function Privacy({ app }: Props) {
    return (
        <div className="px-10 pt-10 pb-20">
            <strong>Privacy Policy</strong>
            <p>
                This privacy policy applies to the {app} app (hereby referred to
                as &quot;Application&quot;) for mobile devices that was created
                by Rodrigo Mendez (hereby referred to as &quot;Service
            ...
            <p>
                ...
                rodrigomendezdev@gmail.com and they will respond in a reasonable
                time.
            </p>
            <br />
            ...
            <div>
                ...
                <p>
                    ...
                    contact the Service Provider (rodrigomendezdev@gmail.com) so
            ...
            <br />
            <p>This privacy policy is effective as of 2024-07-01</p>
            <br />
...
Privacy.getInitialProps = async (ctx: NextPageContext) => {
    const app = ctx?.query?.app?.toString() || "Lizt";
    return {
        app,
    };
};
