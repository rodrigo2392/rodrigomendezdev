  ...
  return (
    <>
      <Head>
        ...
        <meta itemProp="description" content={post.fields.description} />
        ...
        <meta name="twitter:image:src" content={`https:${post.fields.cover.fields.file.url}`}/>
        
        <meta name="og:title" content={post.fields.title} />
        <meta name="og:description" content={post.fields.description} />
        <meta name="og:image" content={`https:${post.fields.cover.fields.file.url}`} />
        <meta name="og:url" content={`https://rodrigomendez.dev/blog/${slug}`} />
      ...
      <main className={poppins.className}>
        <Navbar />
          ...
          <div className='flex justify-center pt-10 text-primary bg-bgGray pb-10 md:px-10' id="inicio">
